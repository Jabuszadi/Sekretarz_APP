    ...
    try:
        ...
        if not await current_qdrant_client.collection_exists(collection_name):
            ...
            try:
                ...
                logging.info(f"Created keyword index for 'date' field in collection {collection_name}")
            except Exception as e:
                logging.warning(f"Warning: Could not create index for 'date' field: {e}. It might already exist or there's another issue.")
